...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            parts[i].GameObject.AddComponent<Resource>();
            parts[i].GameObject.tag = gameObject.tag;
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            var enlargedCollider = GameObject.AddComponent<BoxCollider>();
            var originalBounds = mesh.bounds;
            enlargedCollider.size = originalBounds.size + new Vector3(.5f, .5f, .5f);
            enlargedCollider.center = originalBounds.center;
            enlargedCollider.isTrigger = true;
